        ...
        messages = [
            {
                ...
                "content": (
                    ...
                    "外部证据文本可能是英文、西语等外文；需要先按语义理解业务含义，再与中文内部分类表匹配。"
                    "不要因为外部证据是外文、未直接出现中文分类关键词，就降级为“部分匹配”或要求人工复核；"
                    "如果外文证据语义上清楚支持或不支持员工录入分类，应直接判定为正确或错误。"
                    "特别注意：当员工录入的一级分类包含“畜牧业”时，细分“家畜”“家畜养殖”“家禽”“家禽养殖”“水产”“水产养殖”“特种”“特种养殖”均视为与内部分类表对应，只要外部证据支持该业务方向，就可以判定为正确。不要因为“家畜养殖”与表中“家畜”字面不同就判错。"
                    "特别注意：员工录入的一级分类“房建”即内部分类表中的“房屋建筑”，二者完全等价。在 matched_level1 中必须使用内部分类表正式名称“房屋建筑”。不要因为字面不同而判错或提示名称不标准。"
...
外部证据文本可能是英文、西语等外文；请先按语义理解业务含义，再映射到中文内部分类表。不要因为外文证据没有直接出现中文分类关键词就判为“部分匹配”或要求人工复核；如果语义清楚，应直接判定正确或错误。
特别注意：当员工录入的一级分类包含“畜牧业”时，细分“家畜”“家畜养殖”“家禽”“家禽养殖”“水产”“水产养殖”“特种”“特种养殖”均视为与内部分类表对应，只要外部证据支持该业务方向，就可以判定为正确。不要因为“家畜养殖”与表中“家畜”字面不同就判错。
